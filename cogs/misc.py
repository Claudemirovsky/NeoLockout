...
class Misc(commands.Cog):
    ...
    async def updateratings(self, ctx):
        ...
        await ctx.send(
            embed=discord.Embed(
                description="Updating ratings", color=discord.Color.green()
            )
        )
        await tasks.update_ratings(self.client)
        await ctx.send(
            embed=discord.Embed(
                description="Ratings updated", color=discord.Color.green()
            )
        )
    ...
    async def updatedb(self, ctx):
        ...
        await ctx.send(
            embed=discord.Embed(
                description="Updating problemset", color=discord.Color.green()
            )
        )
        await tasks.update_problemset(self.client)
        await ctx.send(
            embed=discord.Embed(
                description="Problemset updated", color=discord.Color.green()
            )
        )
    ...
    async def backup(self, ctx):
        ...
        await ctx.send(
            embed=discord.Embed(
                description="Taking backup", color=discord.Color.green()
            )
        )
        await tasks.create_backup(self.client)
        await ctx.send(
            embed=discord.Embed(description="Backup taken", color=discord.Color.green())
        )
    ...
    async def scrape_(self, ctx):
        ...
        await ctx.send(
            embed=discord.Embed(
                description="Scraping problem author list", color=discord.Color.green()
            )
        )
        await tasks.scrape_authors(self.client)
        await ctx.send(
            embed=discord.Embed(description="Done", color=discord.Color.green())
        )
